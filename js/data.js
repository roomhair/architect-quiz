...
const QUIZ = {
  id: 'architect',
  title: '建築家あてクイズ',
  lead: '建築の写真が表示されます。<br>設計した建築家を13人の中から選んでください。',
  prompt: 'この建築を設計したのは？',
  ...
  meta: (q, answer) => `${answer.name}／${q.year}年／${q.place}`,
  ...
  {
    id: 'wright-3', answer: 'wright', image: '',
